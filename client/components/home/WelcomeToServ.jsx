  ...
  return (
    <div className="container my-3 welcome-to-serv">
      ...
      <p className="tagline">
        ...
        those service prices and offer you a selection of services from the most
        expensive to the most inexpensive. So when your lights go out, or your
        hot water cylinder explodes, just tap on our app and your problem will
        be solved before you even have time to worry about it. We&apos;ll get
        you the quotes and you&apos;ll do the choosing.
      </p>
      <p>
        We take the hassle out lifes unexpected maintenance problems We are here
        to ensure all your service needs and requirements are met in an easy and
        efficient manner. It&apos;s all about simplicity.
      </p>
      <p>
        Our aim is to make your life easier by finding the service providers for
        you. Our service providers are trained and certified in all aspects of
        Health and Safety procedures including Workplace Hygiene, HACCP Hazard
        Analysis and Critical Control Point, and GMP, Good Manufacturing
        Practices.
      </p>
      <p>
